...
<head>
	...
	<script type="text/javascript" language="javascript" src="container.js"></script>
                         ...
                         <div class="panel panel-default">
                             ...
                             <div class="panel-body">
                              <div class="container">
									...
									echo '<table id="customers"><tr><td>编号</td><td>用户账号</td><td>节点名</td><td>节点位置</td><td>传感器1</td><td>传感器2</td></tr>';
